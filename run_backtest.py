...
# 2. 下載數據
# ===========================
# 為了從 2025-01-01 開始回測，我們需要下載更早的數據來計算 RSI (Buffer 期)
DOWNLOAD_START = "2024-06-01" 
BACKTEST_START = "2025-01-01"  # 🔥 修改這裡：改成 2025 年 1 月 1 日
TODAY = "2026-02-11"
...
# 生成回測日期範圍 (日曆日，包含週末)
# 生成回測日期範圍
dates = pd.date_range(start=BACKTEST_START, end="2026-02-10") # 🔥 確認這裡使用變數 BACKTEST_START
